...
//{
	...
	*/
	EDK_API int
		EE_EngineConnect(const char* strDevID /*= "Emotiv Systems-5" eperfa*/);
	...
	*/
	EDK_API int
		EE_OptimizationIsEnabled(/*bool* pEnabledOut eperfa*/);
	...
	*/
	...
	EDK_API /*bool*/ void EE_CheckSecurityCode(double x); //check your Id code
	...
	*/
	...
	/*!
		...
		\return EDK_ERROR_CODE
		        - EDK_ERROR_CODE = EDK_OK if the command succeeded
	*/
	EDK_API int EE_DataAcquisitionEnable(unsigned int userId/*, bool enable eperfa*/);
	...
	/*!
		...
		\return EDK_ERROR_CODE
		        - EDK_ERROR_CODE = EDK_OK if the command succeeded
	*/
	EDK_API int EE_DataAcquisitionIsEnabled(unsigned int userId/*, bool* pEnableOut eperfa*/);
